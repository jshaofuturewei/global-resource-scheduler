...
import (
	...
	klog "k8s.io/klog"
	"k8s.io/kubernetes/globalscheduler/pkg/apis/allocation/client/clientset/versioned/scheme"
...
// AllocationV1Client is used to interact with features provided by the allocation group.
type AllocationV1Client struct {
	restClients []rest.Interface
	configs     *rest.Config
}

func (c *AllocationV1Client) Allocations(namespace string) AllocationInterface {
	return newAllocationsWithMultiTenancy(c, namespace, "system")
}

func (c *AllocationV1Client) AllocationsWithMultiTenancy(namespace string, tenant string) AllocationInterface {
	return newAllocationsWithMultiTenancy(c, namespace, tenant)
}
...
func New(c rest.Interface) *AllocationV1Client {
	...
	return &AllocationV1Client{restClients: clients}
}
...
func (c *AllocationV1Client) RESTClients() []rest.Interface {
	if c == nil {
		return nil
	}
...
func (c *AllocationV1Client) run() {
	go func(c *AllocationV1Client) {
