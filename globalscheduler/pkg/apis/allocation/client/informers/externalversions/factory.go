...
import (
	...
	allocation "k8s.io/kubernetes/globalscheduler/pkg/apis/allocation/client/informers/externalversions/allocation"
...
func (f *sharedInformerFactory) Allocation() allocation.Interface {
	return allocation.NewWithMultiTenancy(f, f.namespace, f.tweakListOptions, f.tenant)
}
