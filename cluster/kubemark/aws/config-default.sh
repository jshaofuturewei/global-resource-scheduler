...
MASTER_SIZE=${KUBEMARK_MASTER_SIZE:-t2.large}
MASTER_DISK_TYPE=gp2
MASTER_DISK_SIZE=${MASTER_DISK_SIZE:-20}
MASTER_ROOT_DISK_SIZE=${KUBEMARK_MASTER_ROOT_DISK_SIZE:-20}
...
MASTER_OS_DISTRIBUTION=${KUBE_MASTER_OS_DISTRIBUTION:-xenial}
NODE_OS_DISTRIBUTION=${KUBE_NODE_OS_DISTRIBUTION:-xenial}
MASTER_IMAGE=${AWS_IMAGE_NAME:-k8s-1.15-debian-stretch-amd64-hvm-ebs-2019-06-21}
...
NETWORK=${NETWORK_PROVIDER:-kubenet}
...
MASTER_IP_RANGE="${MASTER_IP_RANGE:-10.247.0.0/24}"
CLUSTER_IP_RANGE="${CLUSTER_IP_RANGE:-10.244.0.0/16}"
API_BIND_PORT=${KUBE_API_BIND_PORT:-443}
RUNTIME_CONFIG="${KUBE_RUNTIME_CONFIG:-}"
TERMINATED_POD_GC_THRESHOLD=${TERMINATED_POD_GC_THRESHOLD:-100}
KUBE_APISERVER_REQUEST_TIMEOUT=1800
